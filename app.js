...
alert('All done! Ready for your totally-accurate self story')

let originalStory = (
    `<h2>In the land of the ${userInputs[0]}, in ${userInputs[1]} ${userInputs[2]},
    there is a ${userInputs[3]} named ${userInputs[4]}.</h2>
    <h2>${userInputs[4]} ${userInputs[5]} near a large national park, where
    there are golden ${userInputs[6]}, and big grey ${userInputs[7]}.</h2>
    <h2>${userInputs[4]}'s family keep ${userInputs[8]}, ${userInputs[9]} and ${userInputs[10]} and
    depend on farming the land for food for their animals.</h2> 
    <h2>${userInputs[4]} ${userInputs[11]} to school 
    and helps ${userInputs[12]} family ${userInputs[13]} for the animals when ${userInputs[14]} is home</h2>`
)
